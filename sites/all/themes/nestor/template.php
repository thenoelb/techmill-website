...
function nestor_preprocess_page(&$variables) {
  ...
  // Create variable if there are no sidebars.
  ...
  $variables['logo_classes'] = 'logo col-xs-12 col-md-4 text-center-sm';
  $variables['header_classes'] = 'col-xs-12 col-md-8';
 ...
 */
function nestor_preprocess_block(&$vars) {
  if (isset($vars['elements']['#block']->sidebar_exists) && $vars['elements']['#block']->sidebar_exists == FALSE) {
